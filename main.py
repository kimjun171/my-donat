...
fig4.update_traces(
    ...
    hovertemplate="<b>%{hovertext}</b><br><b>개봉일 스크린수:</b> %{x:,}개<br><b>총 관객수:</b> %{y:,}명<extra></extra>",
)
...
fig6.update_traces(
    hovertemplate="<b>%{hovertext}</b><br><b>개봉일 스크린수:</b> %{x:,}개<br><b>총 관객수:</b> %{y:,}명<br><b>첫 주 관객수:</b> %{marker.size:,}명<extra></extra>"
)
...
fig8.update_traces(
    marker=dict(size=9, opacity=0.8),
    hovertemplate="<b>%{hovertext}</b><br><b>개봉일 스크린수:</b> %{x:,}개<br><b>개봉일 상영 횟수:</b> %{y:,}회<extra></extra>",
)
